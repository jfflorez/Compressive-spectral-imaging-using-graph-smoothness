...
class DualCameraSDCassiModel:
    ...
    def __init__(self,sdcassi_obj,spectral_sen) -> None:
        """
            Parameters:
    ...
    def take_simulated_snapshots(self,X,SNR1,SNR2):
        ...
        if not hasattr(self,'Rmtx'):
            ...
            print('System matrix Rmtx has been successfully created and added to models attributes.')
...
dc_sdcassi_model = DualCameraSDCassiModel(sdcassi_model,np.ones((1,L)))
